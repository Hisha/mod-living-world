...
CREATE TABLE IF NOT EXISTS `lw_hunt` (
  ...
  PRIMARY KEY (`id`), KEY `idx_lw_hunt_level` (`min_level`,`max_level`,`enabled`)
...
CREATE TABLE IF NOT EXISTS `lw_hunt_zone` (
  ...
  `enabled` TINYINT(1) UNSIGNED NOT NULL DEFAULT 1,
  `comment` VARCHAR(255) NULL,
  PRIMARY KEY (`id`), KEY `idx_lw_hunt_zone_hunt` (`hunt_id`,`enabled`), KEY `idx_lw_hunt_zone_zone` (`zone_id`,`enabled`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `lw_hunt_final_location` (
  ...
  `x` FLOAT NOT NULL, `y` FLOAT NOT NULL, `z` FLOAT NOT NULL, `orientation` FLOAT NOT NULL DEFAULT 0,
  `location_name` VARCHAR(120) NOT NULL,
  `weight` INT UNSIGNED NOT NULL DEFAULT 100,
  `enabled` TINYINT(1) UNSIGNED NOT NULL DEFAULT 1,
  `comment` VARCHAR(255) NULL,
  PRIMARY KEY (`id`), KEY `idx_lw_hunt_final` (`hunt_id`,`zone_id`,`enabled`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `lw_hunt_giver` (
  ...
  `enabled` TINYINT(1) UNSIGNED NOT NULL DEFAULT 1,
  `comment` VARCHAR(255) NULL,
  PRIMARY KEY (`id`), UNIQUE KEY `uq_lw_hunt_giver_entry` (`creature_entry`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
